...
//  TravelDiary
//
//  Created by Shreya Prasad on 03/10/25.
//

import Foundation

func getFlagEmoji(from currencyCode: String) -> String {
  ...
  let currencyToCountry: [String: String] = [
    ...
    "VUV": "VU", "WST": "WS", "XAF": "CM", "XCD": "LC", "XDR": "🌍",
    "XOF": "SN", "XPF": "PF", "YER": "YE", "ZAR": "ZA", "ZMW": "ZM",
    "ZWL": "ZW",
  ]

  guard let countryCode = currencyToCountry[currencyCode.uppercased()] else {
    return "🏳️"
  }
  ...
  for scalar in countryCode.uppercased().unicodeScalars {
    if let unicodeValue = UnicodeScalar(base + scalar.value) {
      emoji.append(String(unicodeValue))
    }
  }
